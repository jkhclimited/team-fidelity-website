        ...
        return (
            <div className="aboutPage">
                ...
                <div className="aboutSaloy staffMember">
                    <h3>Founder/Visionary - Christopher "Saloy" Shabalabadingdong</h3>
                    <img className="imageSaloy" alt="Saloy" src={imgSaloy} />
                ...
                <div className="aboutRafu staffMember">
                    <h3>Co-Founder/Coding/Planning/Financials - Justin "Rafu" Chan</h3>
                    <img className="imageRafu" alt="Rafu" src={imgRafu} />
                ...
                <div className="aboutTeenie staffMember">
                    <h3>Co-Founder/HR - Kathleen "Teenie" Xiong</h3>
                    <img className="imageTeenie" alt="Teenie" src={imgTeenie} />
